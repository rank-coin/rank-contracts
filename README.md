...
The RANK Token sale will start on February 15, 2018. More details: http://rankcoin.name/how-to-buy-rank-tokens/
...
<br>
```javascript
uint256 public constant SOFT_CAP_IN_ETHER = 3300 ether;
```
