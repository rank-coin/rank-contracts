...
contract RankCoinCrowdsale is SaleLimitCrowdsale {
  ...
  function RankCoinCrowdsale(uint256 _startTime, uint256 _endTime, uint256 _rate, uint256 _limit, uint256 _emission, address _wallet, address _frozenTokensWallet, address _teamTokensWallet, address _tokenContractAddress) public
    ...
    Crowdsale(_startTime, _endTime, _rate, _wallet)
  {
    ...
    token = RankCoin(_tokenContractAddress);
    decimals = RankCoin(token).decimals();
